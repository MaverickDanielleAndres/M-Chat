...
export function Features8() {
    return (
        <section className="bg-transparent py-10 md:py-16">
            <div className="mx-auto max-w-3xl lg:max-w-4xl px-8">
                <div className="mb-10 text-center">
                    <h2 className="text-xl md:text-2xl font-display font-bold text-[var(--m-text-primary)] leading-tight tracking-tight">
                        Built for modern teams
                    </h2>
                    <p className="mt-2 text-xs md:text-sm text-[var(--m-text-secondary)] max-w-md mx-auto">
                        Everything you need to scale your AI workflow securely and efficiently.
                    </p>
                </div>
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-4">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 border-white/[0.08] bg-[var(--m-bg-card)] shadow-lg shadow-black/20">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative flex h-16 w-40 items-center">
                                    <svg className="text-[var(--m-accent-blue)]/20 absolute inset-0 size-full" viewBox="0 0 254 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span className="mx-auto block w-fit text-3xl font-display font-bold text-[var(--m-text-primary)]">100%</span>
                                </div>
                                <h2 className="mt-4 text-center text-lg font-semibold text-[var(--m-text-primary)]">Model Agnostic</h2>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 border-white/[0.08] bg-[var(--m-bg-card)] shadow-lg shadow-black/20">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-24 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5 bg-[#0a0a10]">
                                    <svg className="m-auto h-fit w-16 text-[var(--m-accent-blue)]" viewBox="0 0 212 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="relative z-10 mt-5 space-y-1.5 text-center">
                                    <h2 className="text-base font-medium transition text-[var(--m-text-primary)]">Enterprise Security</h2>
                                    <p className="text-[var(--m-text-secondary)] text-[11px] leading-relaxed">End-to-end encryption with Row Level Security and SOC 2 compliance out of the box.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 border-white/[0.08] bg-[var(--m-bg-card)] shadow-lg shadow-black/20">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    <svg className="text-white/20 w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M29 23V35" stroke="var(--m-bg-card)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M35 29L29 35L23 29" stroke="var(--m-bg-card)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M55.2373 32H58.7988C61.7383 32 63.4404 30.1816 63.4404 27.0508V27.0371C63.4404 23.9404 61.7246 22.1357 58.7988 22.1357H55.2373V32ZM56.7686 30.6807V23.4551H58.6279C60.6719 23.4551 61.8818 24.7881 61.8818 27.0576V27.0713C61.8818 29.3613 60.6924 30.6807 58.6279 30.6807H56.7686Z" fill="currentColor" />
                                    </svg>
                                </div>
                                <div className="relative z-10 mt-10 space-y-1.5 text-center">
                                    <h2 className="text-base font-medium transition text-[var(--m-text-primary)]">Lightning Fast</h2>
                                    <p className="text-[var(--m-text-secondary)] text-[11px] leading-relaxed">Sub-second streaming responses and instant file analysis. Stay in the zone.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 border-white/[0.08] bg-[var(--m-bg-card)] shadow-lg shadow-black/20">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-10 lg:space-y-6">
                                    <div className="relative flex aspect-square size-10 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5 bg-[#0a0a10]">
                                        <Shield className="m-auto size-4 text-[var(--m-accent-amber)]" strokeWidth={1.5} />
                                    </div>
                                    <div className="space-y-1.5">
                                        <h2 className="text-base font-medium text-[var(--m-text-primary)] transition">Complete Control</h2>
                                        <p className="text-[var(--m-text-secondary)] text-[11px] leading-relaxed">Deploy on your own infrastructure or use our secure cloud. You own your workspace.</p>
                                    </div>
                                </div>
                                <div className="rounded-tl-2xl relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-white/[0.08] bg-[#0a0a10] p-6 py-6 sm:ml-6">
                                    <div className="absolute left-3 top-2 flex gap-1">
                                        <span className="block size-2 rounded-full border border-white/10 bg-white/10"></span>
                                        <span className="block size-2 rounded-full border border-white/10 bg-white/10"></span>
                                        <span className="block size-2 rounded-full border border-white/10 bg-white/10"></span>
                                    </div>
                                    <svg className="w-full sm:w-[150%] text-[var(--m-accent-blue)]/50 mt-4" viewBox="0 0 366 180" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 150 L50 120 L100 130 L150 90 L200 110 L250 60 L300 80 L350 20" stroke="currentColor" strokeWidth="3" fill="none" />
                                    </svg>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 border-white/[0.08] bg-[var(--m-bg-card)] shadow-lg shadow-black/20">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-10 lg:space-y-6">
                                    <div className="relative flex aspect-square size-10 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5 bg-[#0a0a10]">
                                        <Users className="m-auto size-4 text-[#10b981]" strokeWidth={1.5} />
                                    </div>
                                    <div className="space-y-1.5">
                                        <h2 className="text-base font-medium transition text-[var(--m-text-primary)]">Collaborate Seamlessly</h2>
                                        <p className="text-[var(--m-text-secondary)] text-[11px] leading-relaxed">Share workspaces, prompts, and insights with your entire team in real-time.</p>
                                    </div>
                                </div>
                                <div className="before:bg-white/[0.08] relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded-lg border border-white/10 bg-[#0a0a10] px-2 py-1 text-xs shadow-sm text-white/80">Sarah</span>
                                            <div className="size-7 rounded-full bg-[var(--m-accent-blue)] ring-4 ring-[#0a0a10] flex items-center justify-center text-xs font-bold text-white">S</div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="size-8 rounded-full bg-[#10b981] ring-4 ring-[#0a0a10] flex items-center justify-center text-xs font-bold text-white">M</div>
                                            <span className="block h-fit rounded-lg border border-white/10 bg-[#0a0a10] px-2 py-1 text-xs shadow-sm text-white/80">Mike</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded-lg border border-white/10 bg-[#0a0a10] px-2 py-1 text-xs shadow-sm text-white/80">Alex</span>
                                            <div className="size-7 rounded-full bg-[var(--m-accent-amber)] ring-4 ring-[#0a0a10] flex items-center justify-center text-xs font-bold text-white">A</div>
                                        </div>
                                    </div>
                                </div>
                            </CardContent>
